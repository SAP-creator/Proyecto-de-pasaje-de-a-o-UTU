...
class Controller_Sign {
    ...
    static public function sign_in(array $data): Util_HttpResponse 
    {
        ...
        try {
            ...
            $real_hash_password = $user[Util_Translator::json_to_sql(json_password)];
            ...
            $token_user = [
                json_user => [
                    json_ci => $user[Util_Translator::json_to_sql(json_ci)],
                    json_completeuser => $user[Util_Translator::json_to_sql(json_completeuser)],
                    json_typeuser => $user[Util_Translator::json_to_sql(json_typeuser)]
                ]
            ];
    ...
    static public function sign_up(array $data): Util_HttpResponse 
    {
        ...
        try {
            ...
            // NOTA: Se remueve add_log_user porque fallará por Foreign Key si el usuario aún no existe en la tabla `usuario`.
